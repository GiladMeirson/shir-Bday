  ...
  const CONFIG = {
    ...
    faq: {
      ...
      items: [
        ...
        {
          q: "צריך ביטוח נסיעות !",
          a: "נכון מאמי שלי, גם את זה את יכולה לראות כסגור ונעול.",
        },
        {
          q:" מה עם מזג האוויר?",
          a:"תכננתי את זה ככה, שאנחנו נמצאים ביעד מושלם מבחינת מזג אוויר, יכול להיות גשם פה ושם אבל אנחנו נהייה במסאזים בזמן הזה 😉"
        },
      ],
